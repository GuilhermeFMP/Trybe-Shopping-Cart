...
Primeiro projeto de Front-End fornecido pela instituição Trybe, onde criamos um website utilizando Api e funções assincronas.


## Aprendizados

Aprendi sobre funções assincronas, além de promises e fetches, async/await e testes assincronos.

## Stack utilizada

**Fundamentais:** HTML, CSS, Javascript e Jest
...
```bash
  git clone git@github.com:GuilhermeFMP/Trybe-Shopping-Cart.git
